	...
	return (
        ...
        <div className="col-span-1">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            ...
            <a href="https://calendly.com/aryateja/30min?month=2025-09" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center space-x-2 px-4 py-2 border border-gray-600 rounded-md text-gray-300 hover:bg-gray-800 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="mt-6 flex space-x-4">
			<a href="https://github.com/aryateja2106" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-50 transition-colors">
            ...
            <a href="https://www.linkedin.com/in/arya-teja-rudraraju/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-50 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://x.com/r_aryateja" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-50 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 24 24" fill="currentColor">
